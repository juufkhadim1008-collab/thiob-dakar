    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
      <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div key={s.status} className="relative flex items-start gap-4">
                  ...
                  <div
                    className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold z-10 transition-all ${
                      isCurrent
                        ? 'brand-gradient-orange text-white ring-4 ring-[#FA8038]/20 shadow-md scale-110'
                        : isPassed
        ...
        <div className="p-4 border-t border-[#E2ECE5] bg-[#F7FAF7] flex justify-end">
          <button
            onClick={() => setActiveTrackingOrder(null)}
            className="px-6 py-2.5 rounded-full brand-gradient text-white text-xs font-bold hover:opacity-95 shadow-md"
          >
            Fermer le suivi
          </button>
        </div>
