...
export default function CourierSpace() {
  ...
  // Active mission assigned to this courier
  const activeOrder = orders.find((o) => o.id === currentCourier.activeOrderId);

  // Available missions waiting for pickup across Dakar
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 border border-[#E2ECE5] shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <button
          ...
          className={`px-5 py-3 rounded-2xl font-extrabold text-xs flex items-center gap-2 shadow-md transition-all active:scale-95 ${
            isOnline
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded-3xl border border-[#E2ECE5] shadow-xs text-center">
      ...
      {activeOrder && (
        <div className="bg-white rounded-3xl border-2 border-[#008235] p-6 shadow-xl space-y-5 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <button
                ...
                className="flex-1 sm:flex-initial px-6 py-2.5 rounded-xl brand-gradient text-white text-xs font-bold shadow-lg hover:opacity-95 flex items-center justify-center gap-1.5"
              >
              ...
              >
                ...
                <div className="flex items-center justify-between sm:justify-end gap-4 shrink-0">
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl brand-gradient-orange text-white text-xs font-bold shadow-md hover:opacity-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5"
                  >
